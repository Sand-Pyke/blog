    ...
    <main class="max-w-4xl mx-auto px-gutter py-stack-lg mt-stack-lg">
      ...
      <Teleport to="body">
        <transition name="dialog">
          <div v-if="showModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4 md:p-6"
                ...
                <div>
                  ...
                  <div class="flex flex-wrap gap-3 mb-2">
                    ...
                    <button v-for="svgIcon in svgIcons" :key="svgIcon.name" type="button"
                      ...
                      <el-image :src="getIconUrl(svgIcon.file)" :alt="svgIcon.name" fit="contain"
      ...
      <DeleteConfirm v-model:visible="showDeleteConfirm" title="确认删除" message="确定要删除这个技能吗？"
        sub-message="此操作无法撤销，请谨慎操作" confirm-text="删除" :loading="isDeleting" @confirm="handleDeleteConfirm"
